...
Function matrix_mul multiplting 2 matrices
...
def matrix_mul(m_a, m_b):
    ...
    Raises:
        ...
        TypeError: if list of m_a/m_b is null have integers or floats
        TypeError: if the rows of m_a/m_b don't have the same size
